...
internal data class FilmDetails(
        ...
        val budget: Int,
        val revenue: Int) : DomainConvertible<FilmDetails> {

    override fun asDomain(): FilmDetails = FilmDetails(id, title, overview, voteCount, voteAverage, posterPath, backdropPath, budget, revenue)
}
