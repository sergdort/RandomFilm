...
import com.randomfilm.sergdort.scenes.filmdetails.FilmDetailsAssembly
...
class Dependencies private constructor(){
    ...
    fun makeFilmDetailsAssembly(): FilmDetailsAssembly = FilmDetailsAssembly(useCaseFactory.makeFilmDetailsUseCase())
}
